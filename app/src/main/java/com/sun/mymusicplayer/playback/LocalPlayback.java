 ...
 */
package com.sun.mymusicplayer.playback;
...
import com.sun.mymusicplayer.MusicService;
import com.sun.mymusicplayer.model.MusicProvider;
import com.sun.mymusicplayer.model.MusicProviderSource;
...
public final class LocalPlayback implements Playback {
    ...
    public void play(QueueItem item) {
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            // TODO: 2017/9/29 要求一直保持唤醒状态 因为需要保持Wifi连接 
            mWifiLock.acquire();
        }
